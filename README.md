...
<ul>
  ...
  <li><b>SonetaMicrosoftTestingExtensionsPackageVersion</b> - wspólna wersja rozszerzeń Microsoft.Testing.Extensions.* (CrashDump, HangDump, Retry, TrxReport). Musi odpowiadać wersji Microsoft.Testing.Platform, którą pociąga za sobą <b>NUnit3TestAdapter</b> (przez Microsoft.Testing.Extensions.VSTestBridge) - rozjazd tych wersji powoduje błędy ładowania w host procesie testów. Poszczególne rozszerzenia można nadal nadpisać osobno przez SonetaMicrosoftTestingExtensions{CrashDump,HangDump,Retry,TrxReport}PackageVersion.</li>
